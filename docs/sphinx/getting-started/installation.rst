...
http2 targets C++20 and builds with clang ≥ 14 or gcc ≥ 11. It depends
only on the base `polycpp <https://github.com/enricohuang/polycpp>`_ library
(and nghttp2 (linked via POLYCPP_NGHTTP2_LIB)).
...
If you already have http2 and polycpp checked out side by side, tell
...
.. code-block:: bash
   ...
   cmake -B build -G Ninja \
       ...
       -DFETCHCONTENT_SOURCE_DIR_POLYCPP_HTTP2=/path/to/http2
...
issue on the `repository <https://github.com/polycpp/http2/issues>`_
